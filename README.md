...
<h3><b>Math Magician Application</b></h3>
...
# 📖 Math Magician Application<a name="about-project"></a>


Math magician application is a project that allows a user to do basic mathematical operations, view quote page and a home page. I created the project using HTML, CSS, Javascript and react.
...
```sh
git clone git@github.com:sylvester-wamaya/math-magician.git
```
